...
public class OperationBancaireDto implements Serializable {
	...
	public OperationBancaireDto(int idOperation, Date dateOperation,
			double montant, String typeOperation,
	...
	public OperationBancaireDto(Date dateOperation, double montant,
