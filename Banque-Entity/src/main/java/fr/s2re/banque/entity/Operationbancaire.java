...
public class Operationbancaire implements Serializable {
    ...
    public Operationbancaire(Date dateOperation, double montant, Comptebancaire comptebancaire) {
        super();
        this.dateOperation = dateOperation;
        this.montant = montant;
        this.comptebancaire = comptebancaire;
    ...
    public Operationbancaire(int idOperation, Date dateOperation, double montant,
