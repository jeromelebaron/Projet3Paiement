...
public class CarteBancaireDao implements ICarteBancaireDao {
    ...
    public List<Cartebancaire> getCarteByClient(Integer idClient) {
        javax.persistence.Query req = em
                .createQuery("Select distinct c FROM Cartebancaire c WHERE c.comptebancaire.client.idClient = :idClient");
    ...
    public List<Cartebancaire> getCarteByCompte(Integer idCompte) {
        javax.persistence.Query req = em
                .createQuery("Select distinct c FROM Cartebancaire c WHERE c.comptebancaire.idCompte = :idCompte");
