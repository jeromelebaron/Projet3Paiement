...
public class ServiceBanqueWebServiceImp implements IServiceBanqueWebService {
    ...
    public boolean verifierSolde(String nomClient, double montantCommande,
            CarteBancaireDto carteBancaire) {
    ...
    public OperationBancaireDto insertDebit(int idOperation, Date dateOperation, double montant,
        ...
        return operationBancaireBusiness.insertDebit(idOperation, dateOperation, montant,
    ...
    public OperationBancaireDto insertCredit(int idOperation, Date dateOperation, double montant,
            String typeOperation, CompteBancaireDto comptebancaire) {
        return operationBancaireBusiness.insertCredit(idOperation, dateOperation, montant,
                typeOperation, comptebancaire);
    }
