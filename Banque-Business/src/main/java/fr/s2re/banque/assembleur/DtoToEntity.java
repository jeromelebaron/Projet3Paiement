...
public class DtoToEntity {
    ...
    public static Cartebancaire fromCarteBancaireDtoToCarteBancaireEntity(
            CarteBancaireDto carteBancaireDto) {
    ...
    public static List<Comptebancaire> fromListeComptesDtoToListeComptesEntity(
            List<CompteBancaireDto> listeComptesDto) {
        final List<Comptebancaire> listeComptes = new ArrayList<>();
        for (CompteBancaireDto compteBancaireDto : listeComptesDto) {
            final Comptebancaire compte = DtoToEntity
                    .fromCompteBancaireDtoToCompteBancaireEntity(compteBancaireDto);
            listeComptes.add(compte);
        }
        return listeComptes;
    }

    public static Comptebancaire fromCompteBancaireDtoToCompteBancaireEntity(
    ...
    public static Operationbancaire fromOperationBancaireDtoToOperationBancaireEntity(
            OperationBancaireDto operationBancairDto) {
        Operationbancaire operationBancaire = new Operationbancaire();
        dbm.map(operationBancairDto, operationBancaire);
        operationBancaire.setComptebancaire(DtoToEntity
                .fromCompteBancaireDtoToCompteBancaireEntity(operationBancairDto
                        .getComptebancaire()));
    ...
    public static Credit fromCreditDtoToCreditEntity(CreditDto creditDto) {
        ...
        credit.setComptebancaire(DtoToEntity.fromCompteBancaireDtoToCompteBancaireEntity(creditDto
                .getComptebancaire()));
        return credit;
    }
    ...
    public static Debit fromDebitDtoToDebitEntity(DebitDto debitDto) {
        ...
        debit.setComptebancaire(DtoToEntity.fromCompteBancaireDtoToCompteBancaireEntity(debitDto
                .getComptebancaire()));
        return debit;
    }
